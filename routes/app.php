...
// Route Admin
Route::middleware(['role:admin|manager|owner|direktur|cashier'])->group(function () {
...
Route::middleware(['role:owner|direktur'])->group(function () {
...
Route::middleware(['role:admin|manager|owner|direktur|chef|cashier'])->group(function () {
